// FONT
document.writeln("<link href='fonts/font.css' rel='stylesheet'>");

// CSS
// jquery ui
document.writeln("<link rel='stylesheet' href='css/jquery-ui.min.css' />");
document.writeln("<link rel='stylesheet' href='css/jquery-ui.structure.min.css' />");
...
document.writeln("<script src='js/general/Draggable.min.js'></script>");
document.writeln("<script src='js/general/Physics2DPlugin.min.js'></script>");
document.writeln("<script src='js/general/DrawSVGPlugin.min.js'></script>");
document.writeln("<script src='js/general/ThrowPropsPlugin.min.js'></script>");